...
<form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data" name="f">
...
<input class="form-control" id="exampleFormControlInput1" type="text" name="ywgs" required>
<label for="exampleFormControlInput1">WGS 84 (X Google)</label>
<input class="form-control" id="exampleFormControlInput1" type="text" name="xwgs" required>
<label for="exampleFormControlInput1">Область</label>
<select  class="form-control" id="exampleFormControlInput1" name="region"> 
...
<select  class="js-chosen"  id="exampleFormControlInput1" name="towns" placeholder="Выберите город"> 
        <option value=""></option>
        <?php 
...
<input class="form-control" id="exampleFormControlInput1" type="text" name="tel_inf" value="380" required>
...
if (isset($_POST['add-site'])){
		...
		echo 'Карта - Legioner-' . $row_full . '<br>';
